...
// 6. 各软类型的稳定正式查询版本快照 (保证 activeQueryVersion 严格与快照字段绑定)
export const initialQuerySnapshots: Record<string, QueryVersionSnapshot> = {
  PART_MECHANICAL: {
    rootTypeId: 'PART',
    softTypeId: 'PART_MECHANICAL',
    version: 'v1.2.0',
  ...
  PART_FASTENER: {
    ...
    softTypeId: 'PART_FASTENER',
    version: 'v0.9.0',
    syncedAt: '2026-08-20 10:00:00',
    batchId: 'BATCH-20260820-001',
    fields: [
      {
        id: 'MAP-201',
        rootTypeId: 'PART',
        ...
        dataStatus: 'SYNC_SUCCESS',
        isDataImpactingChange: false,
        lastConfigVersion: 'v0.9.0',
        queryVersionBelonging: 'v0.9.0',
  ...
  DOC_DRAWING: {
    ...
    softTypeId: 'DOC_DRAWING',
    version: 'v1.0.0',
    syncedAt: '2026-08-20 16:15:00',
    batchId: 'BATCH-20260820-003',
    fields: [
      {
        id: 'MAP-401',
        rootTypeId: 'DOCUMENT',
...
// 7. 来源元数据旧基线快照 (用于稳定比较来源字段名称/类型变更，而非硬编码)
